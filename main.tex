...
\input{ch2/2.5_Objects_Detection}
\input{ch2/2.6_Customizable_Guidance}
...
\input{ch3/3.2_tools_technolgies}
\input{ch3/3.3_env_setup}
\input{ch3/3.4_localization_qr}
\input{ch3/3.5_obstacle_detection}
\input{ch3/3.6_audio_guidance}
\input{ch3/3.7_system_workflow}
\input{ch3/3.8_testing_evaluation}

...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{placeholder_camera_stand}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{placeholder_qr_code}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{placeholder_belt_setup}

...
A separate interface was also developed within the mobile application to configure the detection range of the obstacle sensors. This screen is shown in \autoref{fig:set-range-screen}.
